...
4. For EACH decision maker:
   ...
   - Invoke /executive-outreach skill with structured input:
     * Contact: name, title, company, email, tier
...
- Outreach Messages: For each DM:
  - Header: ### {rank}. Name | Title | Company | Tier
  - **Email:** Name <email@domain.com> (copy/paste ready format)
  - **Subject Line:** subject line text
  - **Message:** <120 words, personalized, tier-matched
  - Signal: The demand signal making this outreach timely
  - Evidence Used: Which company-specific facts referenced
  - Sender Context: Which bio details used (if applicable)
- Tier Tone Guide: How Tier 1/2/3 differ
- Usage Notes: Customization before sending
</output_requirements>

<quality_standards>
- Write one message per DM (no generic templates)
